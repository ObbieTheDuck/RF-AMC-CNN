...
Source code for the paper is based off of "Deep Learning Based Automatic Modulation Recognition: Models, Datasets, and Challenges", which is published in Digital Signal Processing and "AMC-Benchmark" from Richardzhangxx published on github.

Representative and up-to-date models in the AMR field are implemented on four different datasets (RML2016.10a, RML2016.10b).
